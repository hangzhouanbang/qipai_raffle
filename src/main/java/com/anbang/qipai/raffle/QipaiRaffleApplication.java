package com.anbang.qipai.raffle;
...
import com.anbang.qipai.raffle.conf.FilePathConfig;
import com.anbang.qipai.raffle.cqrs.c.repository.SingletonEntityFactoryImpl;
import com.anbang.qipai.raffle.cqrs.c.service.disruptor.CoreSnapshotFactory;
import com.anbang.qipai.raffle.cqrs.c.service.disruptor.ProcessCoreCommandEventHandler;
import com.anbang.qipai.raffle.cqrs.c.service.disruptor.SnapshotJsonUtil;
import com.anbang.qipai.raffle.init.InitProcessor;
...
@EnableFeignClients
@EnableScheduling
public class QipaiRaffleApplication {
	@Autowired
	...
	public static void main(String[] args) {
		SpringApplication.run(QipaiRaffleApplication.class, args);
	}
